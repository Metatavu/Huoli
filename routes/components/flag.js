...
exports.create = function(req, res){
  ...
  try{
    ...
    flagDAO.create(target_name, target_address, target_phone, target_told, problem_category, source_anonym, source_name, source_address, source_phone, source_email, source_relation, desc, function(flag){
      mailer.sendMail('palveluneuvo@essote.fi', 'Uusi ilmoitus Huoli - järjestelmässä', 'Huoli järjestelmään on tullut uusi ilmoitus, käy katsomassa tarkemmat tiedot: https://essote.huoli.fi/login');
      res.send(flag);
    });
  } catch (e) {
